...
fileprivate func bjs_GPUBindGroupLayout_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueValue: Int32) -> Void
#else
fileprivate func bjs_GPUBindGroupLayout_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueValue: Int32) -> Void {
	fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUBindGroupLayout_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueValue: Int32) -> Void {
	return bjs_GPUBindGroupLayout_label__set_extern(self, newValueIsSome, newValueValue)
}

func _$GPUBindGroupLayout_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
	let selfValue = self.bridgeJSLowerParameter()
	let (newValueIsSome, newValueValue) = newValue.bridgeJSLowerParameter()
	bjs_GPUBindGroupLayout_label__set(selfValue, newValueIsSome, newValueValue)
	if let error = _swift_js_take_exception() {
		throw error
	}
}
...
func _$GPUCommandEncoder__beginRenderPass(
	_ self: JSObject,
	_ descriptor: GPURenderPassDescriptor
) throws(JSException) -> GPURenderPassEncoder {
	let selfValue = self.bridgeJSLowerParameter()
...
func _$GPUCommandEncoder__beginComputePass(
	_ self: JSObject,
	_ descriptor: GPUComputePassDescriptor
) throws(JSException) -> GPUComputePassEncoder {
	let selfValue = self.bridgeJSLowerParameter()
	let descriptorObjectId = descriptor.bridgeJSLowerParameter()
...
fileprivate func bjs_GPUComputePassEncoder__dispatchWorkgroups_extern(
	_ self: Int32,
	_ workgroupCountX: Int32,
	_ workgroupCountY: Int32,
	_ workgroupCountZ: Int32
) -> Void
#else
fileprivate func bjs_GPUComputePassEncoder__dispatchWorkgroups_extern(
	_ self: Int32,
...
#endif
@inline(never) fileprivate func bjs_GPUComputePassEncoder__dispatchWorkgroups(
	_ self: Int32,
	_ workgroupCountX: Int32,
	_ workgroupCountY: Int32,
	_ workgroupCountZ: Int32
...
func _$GPUComputePassEncoder__dispatchWorkgroups(
	_ self: JSObject,
	_ workgroupCountX: Int,
	_ workgroupCountY: Int,
	_ workgroupCountZ: Int
) throws(JSException) -> Void {
	let selfValue = self.bridgeJSLowerParameter()
...
func _$GPUDevice__createBindGroupLayout(
	_ self: JSObject,
	_ descriptor: GPUBindGroupLayoutDescriptor
) throws(JSException) -> GPUBindGroupLayout {
	let selfValue = self.bridgeJSLowerParameter()
	let descriptorObjectId = descriptor.bridgeJSLowerParameter()
...
func _$GPUDevice__createComputePipeline(
	_ self: JSObject,
	_ descriptor: GPUComputePipelineDescriptor
) throws(JSException) -> GPUComputePipeline {
	let selfValue = self.bridgeJSLowerParameter()
	let descriptorObjectId = descriptor.bridgeJSLowerParameter()
...
fileprivate func bjs_GPURenderPassEncoder__draw_extern(
	_ self: Int32,
	_ vertexCount: Int32,
	_ instanceCount: Int32,
	_ firstVertex: Int32,
	_ firstInstance: Int32
) -> Void
#else
fileprivate func bjs_GPURenderPassEncoder__draw_extern(
	_ self: Int32,
...
#endif
@inline(never) fileprivate func bjs_GPURenderPassEncoder__draw(
	_ self: Int32,
	_ vertexCount: Int32,
	_ instanceCount: Int32,
	_ firstVertex: Int32,
...
func _$GPURenderPassEncoder__draw(
	_ self: JSObject,
	_ vertexCount: Int,
	_ instanceCount: Int,
	_ firstVertex: Int,
