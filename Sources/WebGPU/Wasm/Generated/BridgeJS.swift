...
extension GPUPipelineLayoutDescriptor: _BridgedSwiftStruct {
    @_spi(BridgeJS) @_transparent public static func bridgeJSStackPop() -> GPUPipelineLayoutDescriptor {
        let bindGroupLayouts = [GPUBindGroupLayout].bridgeJSStackPop()
        let label = Optional<String>.bridgeJSStackPop()
    ...
    @_spi(BridgeJS) @_transparent public consuming func bridgeJSStackPush() {
        self.label.bridgeJSStackPush()
        self.bindGroupLayouts.bridgeJSStackPush()
    }
...
fileprivate func bjs_GPUBindGroup_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUBindGroup_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUBindGroup_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUBindGroup_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
func _$GPUBindGroup_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    ...
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUBindGroup_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
...
fileprivate func bjs_GPUBindGroupLayout_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUBindGroupLayout_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUBindGroupLayout_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUBindGroupLayout_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}

func _$GPUBindGroupLayout_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUBindGroupLayout_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUBuffer_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUBuffer_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUBuffer_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUBuffer_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
func _$GPUBuffer_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUBuffer_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUCommandBuffer_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUCommandBuffer_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUCommandBuffer_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUCommandBuffer_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}

func _$GPUCommandBuffer_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUCommandBuffer_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUCommandEncoder_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUCommandEncoder_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUCommandEncoder_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUCommandEncoder_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
func _$GPUCommandEncoder_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUCommandEncoder_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUComputePassEncoder_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUComputePassEncoder_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUComputePassEncoder_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUComputePassEncoder_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
func _$GPUComputePassEncoder_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUComputePassEncoder_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUComputePipeline_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUComputePipeline_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUComputePipeline_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUComputePipeline_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}

func _$GPUComputePipeline_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUComputePipeline_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUDevice_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUDevice_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUDevice_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUDevice_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
func _$GPUDevice_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUDevice_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUPipelineLayout_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUPipelineLayout_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUPipelineLayout_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUPipelineLayout_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}

func _$GPUPipelineLayout_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUPipelineLayout_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUQueue_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUQueue_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUQueue_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUQueue_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
func _$GPUQueue_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUQueue_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPURenderPassEncoder_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPURenderPassEncoder_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPURenderPassEncoder_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPURenderPassEncoder_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
fileprivate func bjs_GPURenderPassEncoder__setVertexBuffer_extern(_ self: Int32, _ slot: Int32, _ buffer: Int32) -> Void
#else
fileprivate func bjs_GPURenderPassEncoder__setVertexBuffer_extern(_ self: Int32, _ slot: Int32, _ buffer: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPURenderPassEncoder__setVertexBuffer(_ self: Int32, _ slot: Int32, _ buffer: Int32) -> Void {
    return bjs_GPURenderPassEncoder__setVertexBuffer_extern(self, slot, buffer)
}
...
fileprivate func bjs_GPURenderPassEncoder__setBindGroup_extern(_ self: Int32, _ groupIndex: Int32, _ group: Int32) -> Void
#else
fileprivate func bjs_GPURenderPassEncoder__setBindGroup_extern(_ self: Int32, _ groupIndex: Int32, _ group: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPURenderPassEncoder__setBindGroup(_ self: Int32, _ groupIndex: Int32, _ group: Int32) -> Void {
    return bjs_GPURenderPassEncoder__setBindGroup_extern(self, groupIndex, group)
}
...
func _$GPURenderPassEncoder_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPURenderPassEncoder_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
func _$GPURenderPassEncoder__setVertexBuffer(_ self: JSObject, _ slot: Int, _ buffer: GPUBuffer) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    let slotValue = slot.bridgeJSLowerParameter()
    let bufferValue = buffer.bridgeJSLowerParameter()
    bjs_GPURenderPassEncoder__setVertexBuffer(selfValue, slotValue, bufferValue)
    if let error = _swift_js_take_exception() {
        throw error
    }
}
...
func _$GPURenderPassEncoder__setBindGroup(_ self: JSObject, _ groupIndex: Int, _ group: GPUBindGroup) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    let groupIndexValue = groupIndex.bridgeJSLowerParameter()
    let groupValue = group.bridgeJSLowerParameter()
    bjs_GPURenderPassEncoder__setBindGroup(selfValue, groupIndexValue, groupValue)
    if let error = _swift_js_take_exception() {
        throw error
    }
}
...
fileprivate func bjs_GPURenderPipeline_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPURenderPipeline_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPURenderPipeline_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPURenderPipeline_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
func _$GPURenderPipeline_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPURenderPipeline_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUShaderModule_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUShaderModule_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUShaderModule_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUShaderModule_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}

func _$GPUShaderModule_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUShaderModule_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUTexture_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUTexture_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUTexture_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUTexture_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}
...
func _$GPUTexture_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUTexture_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
...
fileprivate func bjs_GPUTextureView_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void
#else
fileprivate func bjs_GPUTextureView_label__set_extern(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    fatalError("Only available on WebAssembly")
}
#endif
@inline(never) fileprivate func bjs_GPUTextureView_label__set(_ self: Int32, _ newValueIsSome: Int32, _ newValueBytes: Int32, _ newValueLength: Int32) -> Void {
    return bjs_GPUTextureView_label__set_extern(self, newValueIsSome, newValueBytes, newValueLength)
}

func _$GPUTextureView_label__set(_ self: JSObject, _ newValue: Optional<String>) throws(JSException) -> Void {
    let selfValue = self.bridgeJSLowerParameter()
    newValue.bridgeJSWithLoweredParameter { (newValueIsSome, newValueBytes, newValueLength) in
        bjs_GPUTextureView_label__set(selfValue, newValueIsSome, newValueBytes, newValueLength)
    }
    if let error = _swift_js_take_exception() {
        throw error
    }
